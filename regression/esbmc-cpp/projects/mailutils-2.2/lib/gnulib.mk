...
# Reproduce by: gnulib-tool --import --dir=. --local-dir=gl --lib=libmuaux --source-base=lib --m4-base=m4 --doc-base=doc --tests-base=tests --aux-dir=build-aux --avoid=lock --libtool --macro-prefix=gl alloca argp autobuild crypto/des getline getpass-gnu gettext gitlog-to-changelog intprops inttostr malloc mbchar mbiter mbslen mbswidth obstack realloc setenv snprintf stdint strtok_r vasprintf xalloc
...
libmuaux_la_SOURCES =
libmuaux_la_LIBADD = $(gl_LTLIBOBJS)
libmuaux_la_DEPENDENCIES = $(gl_LTLIBOBJS)
EXTRA_libmuaux_la_SOURCES =
libmuaux_la_LDFLAGS = $(AM_LDFLAGS)
...
EXTRA_libmuaux_la_SOURCES += alloca.c

libmuaux_la_LIBADD += @LTALLOCA@
libmuaux_la_DEPENDENCIES += @LTALLOCA@
...
libmuaux_la_SOURCES += argp.h argp-ba.c argp-eexst.c \
...
EXTRA_libmuaux_la_SOURCES += des.c
...
EXTRA_libmuaux_la_SOURCES += basename-lgpl.c dirname-lgpl.c stripslash.c
...
EXTRA_libmuaux_la_SOURCES += error.c

## end   gnulib module error

## begin gnulib module exitfail

libmuaux_la_SOURCES += exitfail.c
...
EXTRA_libmuaux_la_SOURCES += fseeko.c
...
EXTRA_libmuaux_la_SOURCES += getdelim.c
...
EXTRA_libmuaux_la_SOURCES += getline.c
...
EXTRA_libmuaux_la_SOURCES += getopt.c getopt1.c
...
EXTRA_libmuaux_la_SOURCES += getpass.c
...
EXTRA_libmuaux_la_SOURCES += imaxtostr.c inttostr.c offtostr.c uinttostr.c umaxtostr.c

## end   gnulib module inttostr

## begin gnulib module localcharset

libmuaux_la_SOURCES += localcharset.h localcharset.c
...
EXTRA_libmuaux_la_SOURCES += lseek.c
...
EXTRA_libmuaux_la_SOURCES += malloc.c
...
EXTRA_libmuaux_la_SOURCES += mbrtowc.c
...
EXTRA_libmuaux_la_SOURCES += mbsinit.c

## end   gnulib module mbsinit

## begin gnulib module mbslen

libmuaux_la_SOURCES += mbslen.c
...
EXTRA_libmuaux_la_SOURCES += memchr.c
...
EXTRA_libmuaux_la_SOURCES += mempcpy.c
...
EXTRA_libmuaux_la_SOURCES += obstack.c
...
EXTRA_libmuaux_la_SOURCES += rawmemchr.c
...
EXTRA_libmuaux_la_SOURCES += realloc.c
...
EXTRA_libmuaux_la_SOURCES += setenv.c

## end   gnulib module setenv

## begin gnulib module size_max

libmuaux_la_SOURCES += size_max.h
...
EXTRA_libmuaux_la_SOURCES += sleep.c
...
EXTRA_libmuaux_la_SOURCES += snprintf.c
...
EXTRA_libmuaux_la_SOURCES += stdio-write.c
...
EXTRA_libmuaux_la_SOURCES += strcasecmp.c strncasecmp.c
...
EXTRA_libmuaux_la_SOURCES += strchrnul.c
...
EXTRA_libmuaux_la_SOURCES += strerror.c
...
EXTRA_libmuaux_la_SOURCES += strndup.c
...
EXTRA_libmuaux_la_SOURCES += strnlen.c

## end   gnulib module strnlen

## begin gnulib module strnlen1

libmuaux_la_SOURCES += strnlen1.h strnlen1.c
...
EXTRA_libmuaux_la_SOURCES += strtok_r.c
...
libmuaux_la_SOURCES += uniwidth/width.c
...
EXTRA_libmuaux_la_SOURCES += asnprintf.c printf-args.c printf-parse.c vasnprintf.c
...
EXTRA_libmuaux_la_SOURCES += asprintf.c vasprintf.c

## end   gnulib module vasprintf

## begin gnulib module verify

libmuaux_la_SOURCES += verify.h
...
EXTRA_libmuaux_la_SOURCES += vsnprintf.c
...
EXTRA_libmuaux_la_SOURCES += wcwidth.c
...
EXTRA_libmuaux_la_SOURCES += xmalloc.c
